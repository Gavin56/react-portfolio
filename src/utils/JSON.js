const projects = [
  ...
  },
  {
    ...
    description:
      "Proof of concept ecommerce app that allows registered users to browse, buy and sell listed items.",
    image:
  ...
  },
  {
    name: "Weather App",
    description:
      "Find the weather forecast for up to 5 days in cities around the world.",
    image:
